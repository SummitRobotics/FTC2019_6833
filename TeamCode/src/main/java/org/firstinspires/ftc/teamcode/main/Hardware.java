...
public class Hardware {
    ...
    private final double WHEEL_CIRCUMFERENCE = 5.4331 * 3.1415;
    public final int DRIVE_COUNTS_PER_INCH = (int) (HD_HEX_REV_COUNTS * DRIVE_GEAR_RATIO /
            WHEEL_CIRCUMFERENCE);


    private final double HEX_CORE_REV_COUNTS = 288.0;
    private final double LIFT_GEAR_RATIO = 1.0; // This is < 1.0 if geared up
